...
The deb installation smoke queries the package-manager file list after installation, launches the executable registered by `dpkg`, and runs its optional terminal probe against the installed target sidecar and runtime. [Desktop deb installed-runtime smoke](../../implemented/bug-fix/2026-08-23-desktop-deb-installed-runtime-smoke.md) records this path-selection fix; native Linux installation, installed-package terminal UI, update, uninstall, baseline, and GUI evidence remain open.
