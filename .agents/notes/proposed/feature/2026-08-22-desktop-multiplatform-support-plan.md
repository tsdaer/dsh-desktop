...
The current Windows checkout passes 57 desktop script tests, 5 desktop release/update workflow structure tests, the named bilingual-pair checks, and Agent Note format validation. `pnpm run doc-sync` passes all 28 gates, including the documentation build.
