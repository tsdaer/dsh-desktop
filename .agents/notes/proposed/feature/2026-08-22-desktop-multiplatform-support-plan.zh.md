...
剩余工作包括目标原生 Linux 终端、已安装版本更新冒烟、最低基线和打包 GUI 证据；macOS 已配置凭据执行签名 lane、公证／Gatekeeper 证据、已安装版本更新冒烟、文档和 GUI 证据；以及最终的 Windows 回归证据。签名 lane 自动化和清单签名校验不能替代要求的已安装版本更新冒烟。
