...
[Issue-management tests](https://github.com/deepseek-ai/deepseek-harness/blob/master/.github/issue-management/policy.test.mjs) pin the template inventory and headings, the pull-request testing structure, and acceptance of titles, bodies, and assignee states that differ only in presentation.
