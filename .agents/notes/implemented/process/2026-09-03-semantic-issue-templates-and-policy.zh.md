...
[Issue 管理测试](https://github.com/deepseek-ai/deepseek-harness/blob/master/.github/issue-management/policy.test.mjs)固定 template 清单与标题、PR 测试结构，并验证仅展示形式不同的标题、正文和 assignee 状态可以通过。
