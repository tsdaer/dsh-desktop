...
来源：[`packages/shell/bash-wsl/src/index.ts:56`](../packages/shell/bash-wsl/src/index.ts)
...
需要：`tools` · `systemPrompt` · `shellEnv`
...
来源：[`packages/shell/tool-bash-wsl/src/index.ts:31`](../packages/shell/tool-bash-wsl/src/index.ts)
